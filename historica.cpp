...
Historica::Historica(char tipo_lectura, std::string titulo,int minutos, int anio_publicacion, std::string referencia,std::string genero, std::string tema) 
    : Novela( tipo_lectura, titulo, minutos, anio_publicacion, referencia, genero){
        this->tema= tema;
}
